...
<head>
    ...
    <style>
        body {
            background-image: url('image/editprofilebackground.jpeg'); /* Replace with your image URL */
        ...
        .btn-primary {
            background-color: #ba55d3; /* Set your desired color */
            border: none;
        }
        .btn-primary:hover {
            background-color: #9b3eb1; /* Darken the color on hover */
        }
    </style>
    <script>
